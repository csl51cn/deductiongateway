...
public class ConfigTest {
    ...
    public void test() throws Exception {
        System.out.println("version" + baofuConfig.getClassicVersion());
        System.out.println(baofuConfig.getClassicMemberId());
        System.out.println(baofuConfig.getClassicCerFile());
